export default {
  ...
  seo: {
    ...
    ocrPdf: 'PDF OCR Recognition - PDF Elf',
    editPdf: 'Edit PDF Content - PDF Elf',
    pdfToPdfa: 'PDF to PDF/A - PDF Elf',
    flattenPdf: 'Flatten PDF - PDF Elf',
    epubToPdf: 'EPUB to PDF - PDF Elf',
    txtToPdf: 'TXT to PDF - PDF Elf',
    pdfOverlay: 'PDF Overlay - PDF Elf',
    nupPdf: 'N-up Layout - PDF Elf',
  ...
  tools: {
    ...
    ocrPdf: { title: 'OCR Recognition', desc: 'Extract text from scanned / image-based PDFs — export as editable text' },
    editPdf: { title: 'Edit Content', desc: 'Add text, images, or white-out rectangles directly on PDF pages' },
    pdfToPdfa: { title: 'PDF to PDF/A', desc: 'Convert PDF to long-term archive PDF/A format, ISO compliant' },
    flattenPdf: { title: 'Flatten PDF', desc: 'Convert fillable form fields to static content, preventing modification' },
    epubToPdf: { title: 'EPUB to PDF', desc: 'Convert EPUB e-books to PDF documents' },
    txtToPdf: { title: 'TXT to PDF', desc: 'Convert plain text files to formatted PDF documents' },
    pdfOverlay: { title: 'PDF Overlay', desc: 'Overlay two PDFs — second file layered on top of the first' },
    nupPdf: { title: 'N-up Layout', desc: 'Scale multiple pages onto one sheet, supporting 2x1 to 4x4 layouts' },
  ...
  ocrPdf: {
    ...
    desc: 'Upload scanned or image-based PDFs and extract text using AI optical character recognition. Supports English & Chinese — all processing runs locally in your browser.',
    languageLabel: 'Recognition Language',
    langBoth: 'English + Chinese',
    langEng: 'English Only',
    langChs: 'Chinese Only',
    loadingLang: 'Loading language data...',
    loadingHint: 'First use needs to download OCR language data (~15MB). Subsequent uses start instantly.',
    ...
    chars: 'chars',
    reOcr: 'Re-recognize / New File',
    failed: 'Recognition failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Extract text from scanned documents, photographed pages, and image-based PDFs',
        'Supports English & Chinese with mixed recognition mode',
        'Runs Tesseract.js locally in your browser — files never leave your device',
        'Export as plain text for easy editing and searching',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Select a scanned or image-based PDF file' },
        { title: 'Choose Language', desc: 'Pick the recognition language (supports mixed English + Chinese)' },
        { title: 'Start OCR', desc: 'Click the button and AI extracts text page by page' },
        { title: 'Download Text', desc: 'Download the complete .txt file once recognition finishes' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'Which languages are supported?', a: 'English and Simplified Chinese are supported, with a mixed mode for bilingual documents.' },
        { q: 'How accurate is the recognition?', a: 'For clean scans (300+ DPI), English accuracy reaches 95%+, Chinese around 90%+. Blurry, skewed, or handwritten text will reduce accuracy.' },
        { q: 'Are my files uploaded?', a: 'No. The OCR engine (Tesseract.js) runs entirely in your browser. Files never leave your device.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'PDF to Text', path: '/pdf-to-text' },
  ...
  editPdf: {
    ...
    desc: 'Freely add text, insert images, or use white-out rectangles to cover unwanted content on PDF pages — all edits are done directly in your browser.',
    toolText: 'Add Text',
    toolImage: 'Insert Image',
    toolWhiteout: 'White-out',
    toolDelete: 'Delete Selected',
    clearAll: 'Clear All',
    textPopupTitle: 'Enter Text',
    textPlaceholder: 'Type the text to add...',
    fontSize: 'Font Size',
    font: 'Font',
    color: 'Color',
    addText: 'Confirm',
    ...
    seo: {
      featuresTitle: 'Features',
      features: [
        'Add text anywhere on PDF pages, supporting English & Chinese fonts with custom colors and sizes',
        'Insert PNG/JPEG images at specific positions on PDF pages',
        'Use white-out rectangles to cover unwanted content (works like an eraser)',
        'Drag to reposition elements, press Delete to remove selected ones',
      ...
      steps: [
        ...
        { title: 'Choose Tool', desc: 'Pick Add Text, Insert Image, or White-out from the toolbar' },
        { title: 'Add Content', desc: 'Click to add text/images, or drag to draw a white-out rectangle' },
        { title: 'Adjust Position', desc: 'Click to select elements, then drag to reposition. Press Delete to remove.' },
        { title: 'Download PDF', desc: 'Click Apply Edits to generate and download the modified PDF' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'Can I edit existing PDF text?', a: 'Due to PDF format limitations, existing text cannot be directly modified. However, you can cover it with a white-out rectangle and add new text on top.' },
        { q: 'Is Chinese supported?', a: 'Yes. Choose the "Noto Sans SC" font to add Chinese text to your PDF.' },
        { q: 'Are my files uploaded?', a: 'No. All editing is done locally in your browser. Files never leave your device.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Add Watermark', path: '/add-watermark' },
  ...
  pdfa: {
    title: 'PDF to PDF/A',
    desc: 'Convert regular PDF to archive-grade PDF/A format, ISO compliant — ensures readability for decades',
    convertBtn: 'Convert to PDF/A',
    converting: 'Converting to PDF/A...',
    completed: 'PDF/A Conversion Complete',
    failed: 'Conversion failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Convert regular PDFs to ISO-compliant PDF/A format for long-term archival',
        'Embeds standard fonts for consistent display on any device',
        'Preserves original metadata (title, author, etc.) for document integrity',
        'Local browser processing — your files are never uploaded to any server',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Drag & drop or click to select the PDF to convert' },
        { title: 'Click convert', desc: 'Click "Convert to PDF/A" — the system processes the format automatically' },
        { title: 'Download PDF/A file', desc: 'Download the PDF/A-compliant file once conversion completes' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'What is PDF/A format?', a: 'PDF/A is an ISO-standardized subset of PDF designed for long-term archiving. It requires all fonts to be embedded and forbids external dependencies, ensuring the document remains readable decades later.' },
        { q: 'Will PDF/A conversion lose content?', a: 'No — page content, text, and basic formatting are fully preserved. However, certain features forbidden by PDF/A (encryption, JavaScript) are stripped.' },
        { q: 'When should I use PDF/A?', a: 'For legal document archiving, government records, academic papers, corporate archives — any scenario requiring long-term preservation where documents must remain readable regardless of software changes.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Compress PDF', path: '/compress-pdf' },
  ...
  flatten: {
    title: 'Flatten PDF',
    desc: 'Convert fillable form fields into static, read-only content — prevent form modification, ideal for submission and archiving',
    note: 'Flattening is irreversible — form fields become permanent static content. Keep a copy of the original fillable version.',
    flattenBtn: 'Flatten Form',
    flattening: 'Flattening PDF form...',
    completed: 'Flatten Complete',
    failed: 'Flatten failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Convert interactive PDF form fields to static, read-only content — prevent tampering',
        'Supports all form field types: text fields, checkboxes, dropdowns, and more',
        'Output file size remains unchanged, appearance matches the original',
        'Local browser processing — your files are never uploaded to any server',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Drag & drop or select a PDF containing fillable form fields' },
        { title: 'Click flatten', desc: 'Click "Flatten Form" — all form fields are automatically converted to static content' },
        { title: 'Download flattened PDF', desc: 'Download the new PDF with flattened forms' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'Can flattening be undone?', a: 'No — once flattened, form fields are permanently converted to static content. Always keep a backup of the original fillable file.' },
        { q: 'Does flattening affect other PDF content?', a: 'No — only interactive form fields are affected. Page content, layout, and images remain completely unchanged.' },
        { q: 'When should I flatten a PDF?', a: 'When submitting official documents (applications, contracts) to prevent modification. Also useful for printing and archiving.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
  ...
  epubToPdf: {
    title: 'EPUB to PDF',
    desc: 'Convert EPUB e-books to PDF documents — extracts text and auto-formats for reading on any device',
    note: 'EPUB conversion extracts the book\'s text content and reformats it as a PDF. Complex layouts, images, and styles may not be fully preserved.',
    convertBtn: 'Convert to PDF',
    converting: 'Converting EPUB → PDF...',
    completed: 'EPUB Conversion Complete',
    failed: 'Conversion failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Convert EPUB e-book format to universal PDF documents',
        'Automatically extracts and reformats text content from EPUB files',
        'Multiple font choices for clean, readable PDF output',
        'Local browser processing — your e-book files never leave your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload EPUB', desc: 'Drag & drop or select the .epub e-book to convert' },
        { title: 'Click convert', desc: 'Click "Convert to PDF" — the system parses the EPUB and generates a PDF' },
        { title: 'Download PDF', desc: 'Download the generated PDF once conversion is complete' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'Will images from the EPUB be preserved?', a: 'Currently, the tool primarily extracts and converts text content. Images from the EPUB may not be fully preserved in the PDF.' },
        { q: 'Are DRM-protected EPUBs supported?', a: 'No — encrypted or DRM-protected EPUB files cannot be parsed or converted.' },
        { q: 'Will the layout match the original book?', a: 'Text content is fully extracted, but the layout is reformatted. Complex CSS styling, tables, and special layouts may not be perfectly reproduced.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'TXT to PDF', path: '/txt-to-pdf' },
        { label: 'PDF to Text', path: '/pdf-to-text' },
        { label: 'PDF Reader', path: '/pdf-reader' },
      ],
    },
  ...
  txtToPdf: {
    title: 'TXT to PDF',
    desc: 'Convert plain text files to formatted PDF documents — customize font, size, page dimensions, and line spacing',
    fontSize: 'Font Size',
    fontFamily: 'Font',
    fontHelvetica: 'Helvetica (sans-serif)',
    fontTimes: 'Times (serif)',
    ...
    convertBtn: 'Convert to PDF',
    converting: 'Converting TXT → PDF...',
    completed: 'TXT Conversion Complete',
    failed: 'Conversion failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Convert TXT plain text files into neatly formatted PDF documents',
        'Choose from Helvetica, Times, or Courier standard fonts',
        'Customize font size (9pt–18pt) and line spacing (1.0–2.0)',
        'Supports A4 and Letter page sizes',
        'Local browser processing — your text content never leaves your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload TXT file', desc: 'Drag & drop or select a .txt plain text file' },
        { title: 'Configure formatting', desc: 'Choose font, size, page dimensions, and line spacing' },
        { title: 'Download PDF', desc: 'Click "Convert to PDF" and download the formatted document' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'Are Chinese TXT files supported?', a: 'Yes, Chinese characters will display correctly. Some special symbols may have limited rendering due to font constraints.' },
        { q: 'How large can a TXT file be?', a: 'There is no strict limit, but very large files (hundreds of pages) may take longer to process. Consider splitting large files.' },
        { q: 'Can text be selected in the output PDF?', a: 'Yes — all text in the generated PDF is selectable and copyable for further use.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
  ...
  overlay: {
    title: 'PDF Overlay',
    desc: 'Overlay two PDF layers into one — the second file is superimposed on top of the first, page by page',
    baseFile: 'Base File (Background)',
    overlayFile: 'Overlay File (Top Layer)',
    note: 'Both PDFs should have the same number of pages. The overlay file is placed on top of the base. Extra pages are ignored.',
    overlayBtn: 'Overlay & Merge',
    overlaying: 'Overlaying PDF...',
    completed: 'Overlay Complete',
    failed: 'Overlay failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Overlay two PDF layers and merge them into a single file',
        'Each page of the second PDF is superimposed on the corresponding page of the first',
        'Ideal for adding stamps, letterhead templates, or watermark layers',
        'Local browser processing — both files stay on your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload base file', desc: 'Select the background/base PDF (e.g., form, document)' },
        { title: 'Upload overlay file', desc: 'Select the top-layer PDF (e.g., stamp, letterhead)' },
        { title: 'Download merged file', desc: 'Click "Overlay & Merge" and download the combined PDF' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'What if the two PDFs have different page counts?', a: 'The shorter file determines the result — extra pages in the longer file are ignored. For best results, use PDFs with matching page counts.' },
        { q: 'Will the overlay block content underneath?', a: 'Yes — the top layer is placed directly on top. If the overlay has an opaque background, it will obscure the underlying content.' },
        { q: 'How is overlay different from merge?', a: 'Merge combines PDFs sequentially (first file, then second). Overlay stacks the content page-by-page, placing the second file\'s content on top of the first.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Merge PDF', path: '/merge-pdf' },
  ...
  nup: {
    title: 'N-up Layout',
    desc: 'Scale multiple PDF pages onto a single sheet — supports 2×1 through 4×4 layouts. Great for printing handouts and saving paper.',
    layout: 'Layout',
    layout2x1: '2×1 (two pages side by side)',
    layout2x2: '2×2 (four pages per sheet)',
    layout3x2: '3×2 (six pages per sheet)',
    layout3x3: '3×3 (nine pages per sheet)',
    layout4x2: '4×2 (eight pages per sheet)',
    layout4x4: '4×4 (sixteen pages per sheet)',
    nupBtn: 'Generate N-up Layout',
    processing: 'Generating N-up layout...',
    completed: 'N-up Layout Complete',
    failed: 'N-up layout failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Scale multiple PDF pages onto one sheet — layouts from 2×1 to 4×4',
        'Auto-scales content proportionally to fit the new arrangement',
        'Outputs A4 landscape pages, ideal for printing and review',
        'Local browser processing — your files never leave your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Drag & drop or select the PDF for N-up layout' },
        { title: 'Choose layout', desc: 'Pick from 2×1 through 4×4 grid arrangements' },
        { title: 'Download arranged PDF', desc: 'Click to process and download the re-laid-out PDF' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'What is N-up layout used for?', a: 'Primarily for printing handouts, saving paper, and creating thumbnail previews. A 2×2 layout fits 4 PDF pages onto 1 A4 sheet.' },
        { q: 'Will denser layouts affect readability?', a: 'Yes — denser layouts (e.g., 4×4) make each page smaller, reducing readability. 2×2 or 3×2 is recommended for printing; keep the original for on-screen reading.' },
        { q: 'How are pages ordered?', a: 'Pages are arranged left-to-right, top-to-bottom. In a 2×2 layout: page 1 (top-left), page 2 (top-right), page 3 (bottom-left), page 4 (bottom-right).' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Merge PDF', path: '/merge-pdf' },
  ...
  bookmarkSplit: {
    ...
    desc: 'Auto-split a PDF into separate files based on its built-in bookmark/outline structure — each bookmark becomes its own file',
    note: 'This tool requires the PDF to have bookmarks/outlines. If the PDF has no bookmarks, splitting cannot proceed. Split files are packaged as a ZIP download.',
    splitBtn: 'Split by Bookmarks',
    splitting: 'Splitting PDF by bookmarks...',
    completed: 'Split Complete',
    failed: 'Split failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Auto-split documents based on built-in PDF bookmark/outline structure',
        'Each bookmark generates an independent PDF file',
        'Split files packaged as a ZIP for one-click download',
        'Local browser processing — your files never leave your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Drag & drop or select a PDF with bookmarks/outline' },
        { title: 'Click split', desc: 'Click "Split by Bookmarks" — the system reads bookmarks and splits accordingly' },
        { title: 'Download split files', desc: 'Download the ZIP archive and extract to view individual files' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'How do I know if my PDF has bookmarks?', a: 'Open the PDF in any reader and check the sidebar — if you see a table of contents, your PDF has bookmarks. You can also use the PDF Elf Reader to check.' },
        { q: 'How are the split files named?', a: 'Files are named after their bookmark titles for easy identification. Only top-level bookmarks are used for splitting.' },
        { q: 'Will splitting preserve the original formatting?', a: 'Yes — splitting extracts by page ranges and does not alter any page content or layout.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Split PDF', path: '/split-pdf' },
  ...
  deskew: {
    title: 'Deskew PDF',
    desc: 'Auto-detect and correct skewed/tilted scanned pages — straighten crooked PDF pages to proper orientation',
    note: 'Deskew automatically detects and corrects page rotation. Currently supports 90°-increment correction. Subtle tilts of a few degrees may not be fully corrected.',
    deskewBtn: 'Start Deskew',
    deskewing: 'Deskewing PDF...',
    completed: 'Deskew Complete',
    failed: 'Deskew failed, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Automatically detect rotation angle for each PDF page',
        'Correct skewed pages to standard orientation (0°/90°/180°/270°)',
        'Batch-process all pages — fix scanning direction errors in one click',
        'Local browser processing — your files never leave your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Drag & drop or select the scanned PDF to deskew' },
        { title: 'Click deskew', desc: 'Click "Start Deskew" — the system auto-detects and corrects page orientation' },
        { title: 'Download straightened PDF', desc: 'Download the properly-oriented PDF once deskewing completes' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'Can it correct small-angle tilts?', a: 'Currently supports 90°-increment corrections. Scans tilted by just 1–5° may not be fully straightened — consider re-scanning the document.' },
        { q: 'Will deskewing alter PDF content?', a: 'No — deskewing only adjusts page rotation angles; text and image content remain completely unchanged.' },
        { q: 'Does it handle mixed-orientation files?', a: 'Yes — each page is analyzed and corrected independently, so files with pages at different angles are handled correctly.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Rotate PDF', path: '/rotate-pdf' },
  ...
  bates: {
    ...
    desc: 'Add legal Bates stamps to PDF pages — customize prefix, start number, digit count, font size, and position',
    prefix: 'Number Prefix',
    prefixPlaceholder: 'e.g. EXHIBIT- or DEF-',
    ...
    includePageCount: 'Include page count (e.g. BATES-000001/100)',
    batesBtn: 'Add Bates Numbers',
    numbering: 'Adding Bates numbers...',
    completed: 'Bates Numbering Complete',
    failed: 'Failed to add Bates numbers, please try again',
    seo: {
      featuresTitle: 'Features',
      features: [
        'Add Bates numbering stamps to every page of your PDF with customizable prefix',
        'Set starting number and digit count (4/6/8 digits) with auto zero-padding',
        '6 position options: top/bottom × left/center/right',
        'Optional total page count display (e.g. BATES-000001/100)',
        'Uses Courier monospace font for consistent alignment',
        'Local browser processing — your files never leave your device',
      ],
      stepsTitle: 'How to Use',
      steps: [
        { title: 'Upload PDF', desc: 'Drag & drop or select the PDF to add Bates numbers to' },
        { title: 'Set numbering options', desc: 'Enter a prefix, starting number, choose digit count and font size' },
        { title: 'Choose position', desc: 'Pick from six positions for where the Bates number appears' },
        { title: 'Download numbered PDF', desc: 'Click to process and download the PDF with Bates numbers' },
      ],
      faqTitle: 'FAQ',
      faq: [
        { q: 'What is Bates numbering?', a: 'Bates numbering is a system used in the legal industry to identify and track document pages. Each page receives a unique identifier, making it easy to reference specific pages in litigation.' },
        { q: 'Will Bates numbers overlap page content?', a: 'No — numbers are placed in the margin area (20–30pt from the edge) and will not cover body text.' },
        { q: 'Can I number only specific pages?', a: 'Currently, all pages are numbered uniformly. To number a subset, use the Split tool to extract those pages first, then apply Bates numbering.' },
      ],
      relatedTitle: 'Related Tools',
      related: [
        { label: 'Add Page Numbers', path: '/add-page-numbers' },
        { label: 'Header & Footer', path: '/add-header-footer' },
