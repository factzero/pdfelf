<template>
  <div class="tool-page container">
    <h1 class="tool-title"><BookOpenText :size="28" :stroke-width="2" class="tool-title__icon" /> {{ $t('headerFooter.title') }}</h1>
...
import { BookOpenText, FileText } from 'lucide-vue-next'
