<template>
  <div class="tool-page container">
    <h1 class="tool-title"><FolderArchive :size="28" :stroke-width="2" class="tool-title__icon" /> {{ $t('compress.title') }}</h1>
...
import { FileText, FolderArchive } from 'lucide-vue-next'
...
const sizeReduction = computed(() => {
  ...
  return Math.round((1 - resultBlob.value.size / selectedFile.value.size) * 100)
})
