<template>
  <div class="tool-page container">
    <h1 class="tool-title"><Stamp :size="28" :stroke-width="2" class="tool-title__icon" /> {{ $t('watermark.title') }}</h1>
...
import { FileText, Stamp } from 'lucide-vue-next'
