...
export const homeEnSeo: SeoEntry = {
  ...
  description:
    'PDF Elf is a free online PDF tool with 40+ features. Compress, merge, split, convert, encrypt, sign, and more. All processing runs locally — no upload, safe.',
  applicationName: 'PDF Elf',
  category: 'Home',
  categoryEn: 'Home',
}
...
export const toolEnSeos: SeoEntry[] = [
  // ═══════════ Organize PDF ═══════════
  { path: '/compress-pdf', title: 'Compress PDF - PDF Elf | Free Online PDF Compressor', description: 'PDF Elf free online PDF compressor — basic & strong compression modes. Reduce PDF size locally in browser, no upload. Shrink PDFs while maintaining quality.', applicationName: 'PDF Elf — Compress PDF', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  { path: '/merge-pdf', title: 'Merge PDF - PDF Elf | Free Online PDF Merger', description: 'PDF Elf free online PDF merger — drag & drop to reorder files, insert blank pages anywhere. Browser-local, combine multiple PDFs fast, no upload, safe.', applicationName: 'PDF Elf — Merge PDF', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  { path: '/split-pdf', title: 'Split PDF - PDF Elf | Free Online PDF Splitter', description: 'PDF Elf free online PDF splitter — split by page ranges or every N pages. Browser-local, quickly divide a PDF into multiple files, no upload.', applicationName: 'PDF Elf — Split PDF', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  { path: '/rotate-pdf', title: 'Rotate PDF - PDF Elf | Free Online PDF Rotator', description: 'PDF Elf free online PDF rotator — rotate pages 90°, 180°, or 270° with visual thumbnails. Browser-local, zero upload. Fix orientation issues easily.', applicationName: 'PDF Elf — Rotate PDF', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  { path: '/delete-pages', title: 'Delete PDF Pages - PDF Elf | Free Online PDF Page Remover', description: 'PDF Elf free online PDF page remover — check thumbnails to delete unwanted pages. Batch select-all supported, browser-local, original file unaffected.', applicationName: 'PDF Elf — Delete Pages', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  { path: '/extract-pages', title: 'Extract PDF Pages - PDF Elf | Free Online PDF Page Extractor', description: 'PDF Elf free online PDF page extractor — check thumbnails to extract pages into a new PDF. Batch extraction, browser-local, formatting preserved.', applicationName: 'PDF Elf — Extract Pages', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  { path: '/reorder-pages', title: 'Reorder PDF Pages - PDF Elf | Free Online PDF Page Sorter', description: 'PDF Elf free online PDF page reorder tool — drag thumbnails to rearrange page order with high-res preview. Browser-local, original unchanged.', applicationName: 'PDF Elf — Reorder Pages', category: 'Organize PDF', categoryEn: 'Organize PDF' },
  // ═══════════ Edit PDF ═══════════
  { path: '/add-watermark', title: 'Add Watermark to PDF - PDF Elf | Free Online PDF Watermark Tool', description: 'PDF Elf free online PDF watermark tool — custom text, font, opacity, rotation, and color. Watermark every page. Browser-local, protect document copyright.', applicationName: 'PDF Elf — Add Watermark', category: 'Edit PDF', categoryEn: 'Edit PDF' },
  { path: '/add-page-numbers', title: 'Add Page Numbers to PDF - PDF Elf | Free Online PDF Numbering Tool', description: 'PDF Elf free online page number tool — 6 positions, 3 formats, 3 fonts. Browser-local, quickly insert page numbers into PDFs.', applicationName: 'PDF Elf — Add Page Numbers', category: 'Edit PDF', categoryEn: 'Edit PDF' },
  { path: '/add-header-footer', title: 'Add Header & Footer to PDF - PDF Elf | Free Online Tool', description: 'PDF Elf free online header & footer tool — set header & footer text with alignment, fonts, and margins. Browser-local, files stay private.', applicationName: 'PDF Elf — Header & Footer', category: 'Edit PDF', categoryEn: 'Edit PDF' },
  // ═══════════ Security & Tools ═══════════
  { path: '/protect-pdf', title: 'Protect PDF - PDF Elf | Free Online PDF Encryption Tool', description: 'PDF Elf free online PDF encryption — add password and set permissions (print/modify/copy). AES-128 encrypted in browser, file never leaves your device.', applicationName: 'PDF Elf — Protect PDF', category: 'Security & Tools', categoryEn: 'Security & Tools' },
  { path: '/unlock-pdf', title: 'Unlock PDF - PDF Elf | Free Online PDF Password Remover', description: 'PDF Elf free online PDF unlocker — enter password to remove PDF protection. Browser-local, content and layout unchanged, file never leaves device.', applicationName: 'PDF Elf — Unlock PDF', category: 'Security & Tools', categoryEn: 'Security & Tools' },
  { path: '/crop-pdf', title: 'Crop PDF - PDF Elf | Free Online PDF Cropper', description: 'PDF Elf free online PDF cropper — set crop margins on all sides, trim excess from PDF pages. Browser-local, precise cropping applied to all pages.', applicationName: 'PDF Elf — Crop PDF', category: 'Security & Tools', categoryEn: 'Security & Tools' },
  { path: '/extract-images', title: 'Extract Images from PDF - PDF Elf | Free Online Image Extractor', description: 'PDF Elf free online PDF image extractor — scan pages for embedded images, batch-export to original format. Images zipped for download, browser-local, lossless.', applicationName: 'PDF Elf — Extract Images', category: 'Security & Tools', categoryEn: 'Security & Tools' },
  ...
  { path: '/sign-pdf', title: 'Sign PDF - PDF Elf | Free Online PDF Signing Tool', description: 'PDF Elf free online PDF signature tool — image, text, or freehand drawing. 6 preset positions with margin tuning. Browser-local, files stay private.', applicationName: 'PDF Elf — Sign PDF', category: 'More Tools', categoryEn: 'More Tools' },
  { path: '/redact-pdf', title: 'Redact PDF - PDF Elf | Free Online PDF Redaction Tool', description: 'PDF Elf free online PDF redaction tool — permanently redact content with shapes or freehand brush. Rasterized processing, content cannot be recovered.', applicationName: 'PDF Elf — Redact PDF', category: 'More Tools', categoryEn: 'More Tools' },
  { path: '/fill-form', title: 'Fill PDF Form - PDF Elf | Free Online Form Filler', description: 'PDF Elf free online PDF form filler — auto-detect form fields, fill and export. Supports text, checkboxes, dropdowns, radio buttons. Browser-local, data stays private.', applicationName: 'PDF Elf — Fill Form', category: 'More Tools', categoryEn: 'More Tools' },
  // ═══════════ Convert from PDF ═══════════
  { path: '/pdf-to-word', title: 'PDF to Word - PDF Elf | Free Online PDF to Word Converter', description: 'PDF Elf free online PDF to Word converter — convert PDF to editable .docx, preserving formatting. Powered by Pyodide/LibreOffice. Browser-local, files never leave device.', applicationName: 'PDF Elf — PDF to Word', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-excel', title: 'PDF to Excel - PDF Elf | Free Online PDF to Excel Converter', description: 'PDF Elf free online PDF to Excel converter — convert PDF tables to editable spreadsheets. Each page becomes a worksheet. Browser-local, data stays private.', applicationName: 'PDF Elf — PDF to Excel', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-ppt', title: 'PDF to PPT - PDF Elf | Free Online PDF to PPT Converter', description: 'PDF Elf free online PDF to PPT converter — convert PDF to PowerPoint, each page a slide. Freely editable text, browser-local, confidential documents never uploaded.', applicationName: 'PDF Elf — PDF to PPT', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-image', title: 'PDF to Image - PDF Elf | Free Online PDF to Image Converter', description: 'PDF Elf free online PDF to image converter — export PDF as PNG, JPEG, BMP, or TIFF. Adjustable DPI, browser-local, each page as separate image zipped for download.', applicationName: 'PDF Elf — PDF to Image', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-jpg', title: 'PDF to JPG - PDF Elf | Free Online PDF to JPG Converter', description: 'PDF Elf free online PDF to JPG converter — export PDF as high-quality JPG images. Adjustable DPI (72–300), browser-local, fast and secure.', applicationName: 'PDF Elf — PDF to JPG', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-png', title: 'PDF to PNG - PDF Elf | Free Online PDF to PNG Converter', description: 'PDF Elf free online PDF to PNG converter — export PDF as lossless PNG with transparency. Adjustable resolution for HD print. Browser-local, data confidential.', applicationName: 'PDF Elf — PDF to PNG', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-tiff', title: 'PDF to TIFF - PDF Elf | Free Online PDF to TIFF Converter', description: 'PDF Elf free online PDF to TIFF converter — export PDF as TIFF for print publishing and professional imaging. Adjustable resolution, browser-local, highest quality.', applicationName: 'PDF Elf — PDF to TIFF', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-svg', title: 'PDF to SVG - PDF Elf | Free Online PDF to SVG Converter', description: 'PDF Elf free online PDF to SVG converter — merge all pages into one vector SVG, lossless scaling. Browser-local, openable in browsers or design software.', applicationName: 'PDF Elf — PDF to SVG', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-text', title: 'PDF to Text - PDF Elf | Free Online PDF Text Extractor', description: 'PDF Elf free online PDF text extractor — extract plain text, preserving paragraphs and line breaks. Browser-local, ideal for editing or translation.', applicationName: 'PDF Elf — PDF to Text', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  { path: '/pdf-to-html', title: 'PDF to HTML - PDF Elf | Free Online PDF to HTML Converter', description: 'PDF Elf free online PDF to HTML converter — convert PDF to HTML webpage, preserving layout. Generates standalone HTML files. Browser-local, ideal for web publishing.', applicationName: 'PDF Elf — PDF to HTML', category: 'Convert from PDF', categoryEn: 'Convert from PDF' },
  // ═══════════ Convert to PDF ═══════════
  { path: '/word-to-pdf', title: 'Word to PDF - PDF Elf | Free Online Word to PDF Converter', description: 'PDF Elf free online Word to PDF converter — convert .docx to PDF, preserving text and layout. Browser-local, content never leaked.', applicationName: 'PDF Elf — Word to PDF', category: 'Convert to PDF', categoryEn: 'Convert to PDF' },
  { path: '/excel-to-pdf', title: 'Excel to PDF - PDF Elf | Free Online Excel to PDF Converter', description: 'PDF Elf free online Excel to PDF converter — convert .xlsx/.xls to PDF. Preserves table data, each sheet becomes a page. Browser-local, sensitive data not uploaded.', applicationName: 'PDF Elf — Excel to PDF', category: 'Convert to PDF', categoryEn: 'Convert to PDF' },
  { path: '/ppt-to-pdf', title: 'PPT to PDF - PDF Elf | Free Online PPT to PDF Converter', description: 'PDF Elf free online PPT to PDF converter — convert .pptx to PDF for sharing and printing. Browser-local, presentation content stays confidential.', applicationName: 'PDF Elf — PPT to PDF', category: 'Convert to PDF', categoryEn: 'Convert to PDF' },
  { path: '/image-to-pdf', title: 'Image to PDF - PDF Elf | Free Online Image to PDF Converter', description: 'PDF Elf free online image to PDF converter — combine PNG, JPEG, WebP, GIF into one PDF. Custom page size and orientation. Browser-local, one-click merge.', applicationName: 'PDF Elf — Image to PDF', category: 'Convert to PDF', categoryEn: 'Convert to PDF' },
  { path: '/html-to-pdf', title: 'HTML to PDF - PDF Elf | Free Online HTML to PDF Converter', description: 'PDF Elf free online HTML to PDF converter — convert HTML code or files to PDF. Live preview, choose page size. Browser-local, content stays private.', applicationName: 'PDF Elf — HTML to PDF', category: 'Convert to PDF', categoryEn: 'Convert to PDF' },
  // ═══════════ Reader ═══════════
  { path: '/pdf-reader', title: 'PDF Reader - PDF Elf | Free Online PDF Reader', description: 'PDF Elf free online PDF reader — pure browser-based PDF reading, no install needed. Keyboard navigation, zoom, page jumping. Mobile & desktop compatible, no uploads.', applicationName: 'PDF Elf — PDF Reader', category: 'Reader', categoryEn: 'Reader' },
  // ═══════════ More Tools ═══════════
  { path: '/edit-metadata', title: 'Edit PDF Metadata - PDF Elf | Free Online Metadata Editor', description: 'PDF Elf free online PDF metadata editor — view and edit title, author, subject, keywords, and more. Browser-local, no install needed.', applicationName: 'PDF Elf — Edit Metadata', category: 'More Tools', categoryEn: 'More Tools' },
  { path: '/flip-pdf', title: 'Flip PDF Pages - PDF Elf | Free Online PDF Flipper', description: 'PDF Elf free online PDF page flipper — horizontal or vertical mirror flip all pages. Perfect for correcting mis-scanned documents. Browser-local, download instantly.', applicationName: 'PDF Elf — Flip PDF', category: 'More Tools', categoryEn: 'More Tools' },
  { path: '/grayscale-pdf', title: 'Grayscale PDF - PDF Elf | Free Online PDF Grayscale Converter', description: 'PDF Elf free online grayscale converter — convert PDF to black & white, reduce file size. Ideal for printing and archiving. Browser-local, download instantly.', applicationName: 'PDF Elf — Grayscale PDF', category: 'More Tools', categoryEn: 'More Tools' },
  { path: '/resize-pdf', title: 'Resize PDF Pages - PDF Elf | Free Online PDF Resizer', description: 'PDF Elf free online PDF page resizer — change page size to A4, A3, Letter, and more. Content scales proportionally. Browser-local, download immediately.', applicationName: 'PDF Elf — Resize PDF', category: 'More Tools', categoryEn: 'More Tools' },
]
